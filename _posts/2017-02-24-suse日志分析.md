...
|maillog   |sendmail往来日志| 不使用linux邮件系统，无用 | |
...
|SaX.log |Logs from SaX2, the SUSE advanced X11 configuration tool.| |  |
|scpm|Logs from the system configuration profile management (scpm).| |  |
...
[sample data](/attach/suse/message.txt)
...
# 应用日志
/var/log/httpd: 包含服务器accesslog和error log
/var/log/lighttpd/: 包含light HTTPD的accesslog and error log
/var/log/mail/: 包含邮件服务器的额外日志
/var/log/prelink/: 包含.so文件被prelink修改的信息

/var/log/samba/: 包含 由samba存储的信息
/var/log/sa/: 包含每日由sysstat软件包手机的sar文件
